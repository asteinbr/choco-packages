...
$url        = 'https://github.com/nzbget/nzbget/releases/download/v19.1/nzbget-19.1-bin-win32-setup.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'nzbget*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
